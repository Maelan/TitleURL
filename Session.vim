...
silent only
cd /media/MaelanUSB/Documents/Extensions-Firefox/TitleURL
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +3 chrome.manifest
badd +1 install.rdf
badd +5 chrome/content/content.xul
badd +1 chrome/content/script.js
badd +1 chrome/content/style.css
args chrome.manifest install.rdf chrome/content/content.xul chrome/content/script.js chrome/content/style.css
edit install.rdf
