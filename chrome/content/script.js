window.addEventListener("load", function _() {
	...
	var TitleURL = {
		...
		css:      null,    // the stylesheet
		rule1:    null,    // the rule for the URL input
		rule2:    null,    // the rule for the URL input when focused
		...
		initCss: function() {
			...
			for (var i = 0;  !TitleURL.css && i < document.styleSheets.length;  i++)
				if (document.styleSheets[i].href.toLowerCase() === "chrome://titleurl/skin/aspect.css")
